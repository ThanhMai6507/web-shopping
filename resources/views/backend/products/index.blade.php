                ...
                <div class="col-md-12">
                    <div class="card card-table flex-fill">
                        <div class="card-body">
                            <div class="table-responsive no-radius">
                                ...
                                <table class="table table-hover table-center">
                                    <thead>
                                        <tr>
                                            <th>
                                                <x-sort :sortName="'id'" columnTitle="ID"></x-sort>
                                            </th>
                                            <th>
                                                <x-sort :sortName="'name'" columnTitle="Name"></x-sort>
                                            </th>
                                            <th>Category</th>
                                            <th>Price</th>
                                            <th>Image</th>
                                    ...
                                    <tbody>
                                        @foreach ($products as $product)
                                            <tr>
                                                ...
                                                <td class="text-nowrap">
                                                    <div class="font-weight-600">{{ $product->category->name ?? null }}
                                                    </div>
                                                </td>
                                                <td class="text-nowrap">
                                                ...
                                                <td class="text-nowrap" style="width: 15%">
                                                    @if ($product->attachment)
                                                        <img class="img-fluid"
                                                            src="{{ asset('storage/attachments/' . $product->attachment->file_name) }} ">
                                                    @endif
                                                </td>
                                                <td>
                                                    <div class="actions"
                                                        style="display: flex;gap:5px; height:40px; margin:auto">
                                                        <a href="{{ route('products.create') }}"
                                                            style="background: #E0F6F6;"
                                                        ...
                                                        <x-button_delete
                                                            route="{{ route('products.destroyMultiple', ['product_ids' => $product->id]) }}">
                                                        </x-button_delete>

                                                        <a href="{{ route('products.show', ['product' => $product->id]) }}"
                                                            style="background: #E0F6F6; color:#1DB9AA"
                            ...
                            <div>
                                <form id="deleteForm" action="{{ route('products.destroyMultiple', ['product_ids']) }}"
                                    method="POST">
                                    @csrf
                                    @method('delete')
